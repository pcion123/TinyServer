...
{
	private static Logger mLogger = LoggerFactory.getLogger(DateUtil.class);
	...
	public static java.util.Date getStrToDate(String timeStr)
	{
		...
		{
			mLogger.error("getStrToDate error -> {} : {}", timeStr, e.getMessage());
		}
		return null;
	}
	...
	public static long getStrToTimestamp(String timeStr)
	{
		...
		{
			mLogger.error("getStrToTimestamp error -> {} : {}", timeStr, e.getMessage());
		}
		return 0;
	}
