...
{
	private static Logger logger = LoggerFactory.getLogger(PlatformAccountController.class);
    
	@Autowired
	@Qualifier("platformAccountServiceImpl")
	...
	public ResponseData login(LoginReq request)
	{
		...
		return accountService.login(account, password, true);
	}
